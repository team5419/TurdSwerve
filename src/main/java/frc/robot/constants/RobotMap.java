...
public final class RobotMap {
  public static final int leftAzimuthID = 25;//BL
  public static final int rightAzimuthID = 27;//FR

  public static final int leftDriveID = 26;//BL
  public static final int rightDriveID = 28;//FR
